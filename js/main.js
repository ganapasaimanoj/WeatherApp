...
function getWeatherInfo(event) {
    ...
    const geoUrl = `https://crossorigin.me/https://dataservice.accuweather.com/locations/v1/cities/geoposition/search?apikey=${apiKey}&q=${lat},${lon}`;
    ...
    function collectWeatherInfo(cityKey) {
        const weatherUrl = `https://crossorigin.me/https://dataservice.accuweather.com/currentconditions/v1/${cityKey}?apikey=${apiKey}`;
